// SVN $HeadURL: http://alufr-ros-pkg.googlecode.com/svn/trunk/humanoid_stacks/humanoid_navigation/footstep_planner/include/footstep_planner/Heuristic.h $
// SVN $Id: Heuristic.h 3298 2012-09-28 11:37:38Z hornunga@informatik.uni-freiburg.de $
...
public:
  enum HeuristicType
  {
    ...
    EUCLIDEAN_STEP_COST_HEURISTIC = 1,
    PATH_STEP_COST_HEURISTIC      = 2,
    GPR_STEP_COST_HEURISTIC       = 3
  };
...
private:
  ...
  /// longest step width
  const double ivMaxStepDistX;
  const double ivMaxStepDistY;
};
 ...
 * @brief todo
 */
class GPRStepCostHeuristic : public Heuristic
{

public:
  GPRStepCostHeuristic(double cell_size, int num_angle_bins,
                       double step_cost, double diff_angle_cost,
                       double max_step_width);
  virtual ~GPRStepCostHeuristic();
