...
public:
   ...
   */
  Footstep(double x, double y, double theta, double swing_height, double lift_height, double step_duration, double sway_duration,
   ...
   */
  PlanningState performMeOnThisState(const PlanningState& current, const TerrainModel::ConstPtr &terrain_model = TerrainModel::ConstPtr()) const;
   ...
   */
  PlanningState reverseMeOnThisState(const PlanningState& current, const TerrainModel::ConstPtr &terrain_model = TerrainModel::ConstPtr()) const;

  double getStepCost() const { return ivStepCost; }
