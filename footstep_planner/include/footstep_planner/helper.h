// SVN $HeadURL: http://alufr-ros-pkg.googlecode.com/svn/trunk/humanoid_stacks/humanoid_navigation/footstep_planner/include/footstep_planner/helper.h $
// SVN $Id: helper.h 4146 2013-05-13 13:57:41Z garimort@informatik.uni-freiburg.de $
...
inline int disc_val(double length, double cell_size)
{
  ...
  //return int(round(length / cell_size));
}
 ...
 */
bool collision_check(double x, double y, double cos_theta, double sin_theta,
