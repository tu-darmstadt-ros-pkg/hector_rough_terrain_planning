// SVN $HeadURL: http://alufr-ros-pkg.googlecode.com/svn/trunk/humanoid_stacks/humanoid_navigation/footstep_planner/include/footstep_planner/FootstepNavigation.h $
// SVN $Id: FootstepNavigation.h 4170 2013-05-21 11:18:20Z garimort@informatik.uni-freiburg.de $
...
public:
  ...
  /// @brief Wrapper for FootstepPlanner::setGoal.
  bool setGoal(float x, float y, float z, float theta);
