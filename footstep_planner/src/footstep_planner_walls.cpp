// SVN $HeadURL: http://alufr-ros-pkg.googlecode.com/svn/trunk/humanoid_stacks/humanoid_navigation/footstep_planner/src/footstep_planner_walls.cpp $
// SVN $Id: footstep_planner_walls.cpp 4148 2013-05-13 14:55:16Z garimort@informatik.uni-freiburg.de $
...
public:
  FootstepPlannerWallsNode()
  {
    ...
    // service:
    ivFootstepPlanService = ivNh.advertiseService("plan_footsteps", &FootstepPlanner::planFootstepService, &ivFootstepPlanner);
  }
  ...
  void wallMapCallback(const nav_msgs::OccupancyGridConstPtr& occupancyMap)
  {
    ...
    ivFootstepPlanner.updateGroundLevelMap(enlargedWallMap);
  }
protected:
  ros::NodeHandle ivNh;
