...
if LINESEGMENT_MPRIMS == 1
    ...
    basemprimendpts0_c(2,:) = [-2 0 0 backwardcostmult];
    %turn in place
    basemprimendpts0_c(3,:) = [0 0 1 turninplacecostmult];
    basemprimendpts0_c(4,:) = [0 0 -1 turninplacecostmult];
    basemprimendpts0_c(5,:) = [0 0 3 turninplacecostmult];
    basemprimendpts0_c(6,:) = [0 0 -3 turninplacecostmult];    
    ...
    basemprimendpts45_c(5,:) = [0 0 3 turninplacecostmult];
    basemprimendpts45_c(6,:) = [0 0 -3 turninplacecostmult];    
    ...
    basemprimendpts22p5_c(5,:) = [0 0 3 turninplacecostmult];
    basemprimendpts22p5_c(6,:) = [0 0 -3 turninplacecostmult];    
    ...
    basemprimendpts11p25_c(2,:) = [-3 -1 0 backwardcostmult];
    %turn in place
    basemprimendpts11p25_c(3,:) = [0 0 1 turninplacecostmult];
    basemprimendpts11p25_c(4,:) = [0 0 -1 turninplacecostmult];
    basemprimendpts11p25_c(5,:) = [0 0 3 turninplacecostmult];
    basemprimendpts11p25_c(6,:) = [0 0 -3 turninplacecostmult];    
    ...
    basemprimendpts33p75_c(2,:) = [-3 -2 0 backwardcostmult];
    %turn in place
    basemprimendpts33p75_c(3,:) = [0 0 1 turninplacecostmult];
    basemprimendpts33p75_c(4,:) = [0 0 -1 turninplacecostmult];
    basemprimendpts33p75_c(5,:) = [0 0 3 turninplacecostmult];
    basemprimendpts33p75_c(6,:) = [0 0 -3 turninplacecostmult];        
