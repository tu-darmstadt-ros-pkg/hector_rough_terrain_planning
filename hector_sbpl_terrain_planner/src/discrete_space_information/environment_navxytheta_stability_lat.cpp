...
void EnvironmentNAVXYTHETASTAB::InitializeEnvironment()
{
    ...
    EnvXXX.Coord2StateIDHashTable = new vector<EnvNAVXYTHETASTABHashEntry_t*> [EnvXXX.HashTableSize];
...
void EnvironmentNAVXYTHETASTAB::SetAllActionsandAllOutcomes(CMDPSTATE* state)
{
    ...
    EnvNAVXYTHETASTABHashEntry_t* HashEntry = EnvXXX.StateID2CoordTable[state->StateID];
...
void EnvironmentNAVXYTHETASTAB::PrintState(int stateID, bool bVerbose, FILE* fOut /*=NULL*/)
{
    ...
    EnvNAVXYTHETASTABHashEntry_t* HashEntry = EnvXXX.StateID2CoordTable[stateID];
